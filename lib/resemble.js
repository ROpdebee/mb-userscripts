/* Port of https://github.com/rsbml/Resemble.js for use in web workers */
/*
James Cryer / Huddle
URL: https://github.com/Huddle/Resemble.js
*/

function isWebWorker(doc) {
    return typeof document === 'undefined';
}

const resemble = (function() {
    'use strict';
    ...
    var resemble = function(fileData) {
        ...
        function loadImageData(fileDataForImage, callback) {
            if (typeof ImageBitmap !== 'undefined' && fileDataForImage instanceof ImageBitmap) {
                /* We can simply push these */
