...
(function () {
  ...
  function submitUrls(editor, urls) {
    ...
    lastInput.dispatchEvent(new InputEvent('input', {
      bubbles: true
    }));
    setTimeout(() => {
