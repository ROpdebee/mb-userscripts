  ...
  class CoverArtProvider {
    ...
    fetchPage(url, options) {
      ...
      return _call(function () {
        return _await(gmxhr(url, _objectSpread2({
          httpErrorMessages: {
  ...
  class SoundcloudProvider extends ProviderWithTrackImages {
    ...
    lazyLoadTracks(tracks) {
      return _call(function () {
        ...
        return _await(gmxhr("https://api-v2.soundcloud.com/tracks?".concat(params)), function (trackDataResponse) {
          const trackData = safeParseJSON(trackDataResponse.responseText);
          if (!trackData) {
  ...
  class ImageFetcher {
    ...
    fetchImageContents(url, fileName, id, headers) {
      ...
      return _call(function () {
        ...
        return _await(pRetry(() => gmxhr(url, xhrOptions), {
          retries: 10,
          onFailedAttempt: err => {
