...
(function () {
  ...
  var QUERY_SHA256 = 'cd0fe8a7199e97a9027f676838dd25bf88346435f7096fddd79b055d68ea98c8';
  ...
  var AUDIBLE_FRONT_IMAGE_QUERY = '#audibleimageblock_feature_div #main-image';
  class AmazonProvider extends CoverArtProvider {
    ...
    findAudibleImages(_url, _pageContent, pageDom) {
      var _this3 = this;
      return _call(function () {
        return _await(_this3.extractFrontCover(pageDom, AUDIBLE_FRONT_IMAGE_QUERY));
      });
    }
  ...
  class ImageFetcher {
    ...
    fetchImageFromURL(url) {
      ...
      return _call(function () {
        ...
        (_this3$hooks$onFetchS = (_this3$hooks = _this3.hooks).onFetchStarted) === null || _this3$hooks$onFetchS === void 0 || _this3$hooks$onFetchS.call(_this3$hooks, id, url);
        return _await(_finallyRethrows(function () {
          ...
          (_this3$hooks$onFetchF = (_this3$hooks2 = _this3.hooks).onFetchFinished) === null || _this3$hooks$onFetchF === void 0 || _this3$hooks$onFetchF.call(_this3$hooks2, id);
