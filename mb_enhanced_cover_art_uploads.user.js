  ...
  class InputForm {
      constructor(app) {
          ...
          document.head.append(function () {
              ...
              $$a.setAttribute('id', 'ROpdebee_' + USERSCRIPT_ID);
