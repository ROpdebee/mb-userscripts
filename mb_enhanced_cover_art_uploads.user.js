    ...
    _createClass(ImageFetcher, [{
      ...
      value: function () {
        var _fetchImagesFromProvider = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(url, provider) {
          var images, fetchResults, _iterator2, _step2, img, result;
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 3:
                  ...
                  LOGGER.info("Found ".concat(images.length || 'no', " images in ").concat(provider.name, " release"));
                  fetchResults = [];
          ...
          }, _callee3, this, [[7, 30, 33, 36], [14, 23]]);
        }));
