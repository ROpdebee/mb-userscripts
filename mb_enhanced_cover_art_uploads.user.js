...
// @require      https://github.com/qsniyg/maxurl/blob/b2f5a3edd335f623602befcec9ea47adc5ac994c/userscript.user.js?raw=true
  ...
  class InputForm {
      constructor(app) {
          ...
          const container = function () {
              ...
              $$q.appendChild($$s);
              var $$t = document.createTextNode('Supported providers');
              $$s.appendChild($$t);
          ...
          this.fakeSubmitButton = function () {
              ...
              var $$aa = document.createTextNode('Enter edit');
              $$z.appendChild($$aa);
              return $$z;
          }.call(this);
