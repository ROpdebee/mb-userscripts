...
(function () {
  ...
  const PLACEHOLDER_IMG_NAMES = ['01RmK+J4pJL',
  '01QFb8SNuTL',
  '01PkLIhTX3L',
  '01MKUOLsA5L',
  '31CTP6oiIBL'];
  ...
  _defineProperty(ArchiveProvider, "IMAGE_FILE_FORMATS", ['JPEG', 'PNG', 'Text PDF',
  'Animated GIF']);
  ...
  _defineProperty(DatPiffProvider, "placeholderDigests", ['259b065660159922c881d242701aa64d4e02672deba437590a2014519e7caeec',
  'ef406a25c3ffd61150b0658f3fe4863898048b4e54b81289e0e53a0f00ad0ced',
  'a2691bde8f4a5ced9e5b066d4fab0675b0ceb80f1f0ab3c4d453228549560048']);
  ...
  class SoundcloudProvider extends ProviderWithTrackImages {
    ...
    supportsUrl(url) {
      const _url$pathname$trim$sl = url.pathname.trim()
        .slice(1)
        .replace(/\/$/, '').split('/'),
      ...
      return pathParts.length > 0 && !SoundcloudProvider.badArtistIDs.has(artistId)
    ...
    lazyLoadTracks(tracks) {
      return _call(function () {
        const lazyTrackIDs = tracks.filter(track => typeof track.artwork_url === 'undefined').map(track => track.id);
          ...
          reader.addEventListener('load', () => {
            ...
            if ((uint32view[0] & 0x00FFFFFF) === 0x00FFD8FF) {
              ...
              switch (uint32view[0]) {
                ...
                default:
                  resolve({
                    mimeType: (_resp$headers$get = resp.headers.get('Content-Type')) === null || _resp$headers$get === void 0 ? void 0 : (_resp$headers$get$mat = _resp$headers$get.match(/[^;\s]+/)) === null || _resp$headers$get$mat === void 0 ? void 0 : _resp$headers$get$mat[0],
                    isImage: false
                  });
              }
            }
  ...
  class InputForm {
      constructor(app) {
          ...
          const container = function () {
              ...
              $$s.setAttribute('href', '#');
              $$s.addEventListener('click', app.exportDebugLogs.bind(app));
              $$q.appendChild($$s);
              var $$t = document.createTextNode('Export debug logs');
              $$s.appendChild($$t);
              var $$u = document.createElement('a');
              $$u.setAttribute('href', 'https://github.com/ROpdebee/mb-userscripts/blob/main/src/mb_enhanced_cover_art_uploads/docs/supported_providers.md');
          ...
          this.buttonContainer = function () {
              ...
              $$y.setAttribute('class', 'ROpdebee_import_url_buttons buttons');
              return $$y;
          }.call(this);
          this.orSpan = function () {
              var $$z = document.createElement('span');
              setStyles($$z, { display: 'none' });
              var $$aa = document.createTextNode('or');
              $$z.appendChild($$aa);
              return $$z;
          }.call(this);
          ...
          this.fakeSubmitButton = function () {
              ...
              $$bb.setAttribute('class', 'submit positive');
              $$bb.disabled = true;
              $$bb.setAttribute('hidden', true);
              var $$cc = document.createTextNode('\n            Enter edit\n        ');
              $$bb.appendChild($$cc);
              return $$bb;
          }.call(this);
          ...
          return _call(function () {
              return _await(provider.favicon, function (favicon) {
                  const button = function () {
                      ...
                      $$dd.setAttribute('title', url);
                      $$dd.addEventListener('click', evt => {
                          evt.preventDefault();
                          onClickCallback();
                      });
                      var $$ee = document.createElement('img');
                      $$ee.setAttribute('src', favicon);
                      $$ee.setAttribute('alt', provider.name);
                      $$dd.appendChild($$ee);
                      var $$ff = document.createElement('span');
                      $$dd.appendChild($$ff);
                      appendChildren($$ff, 'Import from ' + provider.name);
                      return $$dd;
                  }.call(this);
  ...
  class App {
    constructor() {
      ...
      _defineProperty(this, "collectorSink", new CollectorSink());
      _defineProperty(this, "requestRecorder", new RecordingObserver());
      ...
      return _call(function () {
        ...
        return _await(getURLsForRelease(mbid, {
          ...
          const syncProcessURL = url => {
            void pFinally(_this4.processURL(url).catch(err => {
    ...
    confirmExportRequests() {
      const msg = ['Recorded requests contain responses from the following domains:\n', this.requestRecorder.recordedDomains.join(', ') + '\n', 'Exporting the request responses may leak user credentials and keys if you are logged in to any of these domains! ', 'Do you want to include the responses in the exported debug content?'].join('');
    ...
    exportDebugLogs() {
      ...
      const downloadUrl = URL.createObjectURL(new Blob([exportedContent], {
        type: 'text/plain'
      }));
      downloadAnchor.download = "ECAU-debug-".concat(Date.now(), ".txt");
